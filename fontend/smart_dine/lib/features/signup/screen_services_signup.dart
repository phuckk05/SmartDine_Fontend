...
//                 child: Text('Tạo mới tài khoản', style: Style.fontTitle),
//               ),
...
//           onPressed: () {
//             User user = User.create(fullName: , email: email, phone: phone, password: password, fontImage: fontImage, backImage: backImage)
//           },
