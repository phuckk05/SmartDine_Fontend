...
// import 'package:me_talk/features/forgot_passwork/screen/screen_updatedpasswork.dart';
...
// final textCodeEditTextProvider = StateProvider<TextEditingController>((ref) => TextEditingController(),);
...
//         'Mã đã được gửi về email của bạn , lấy mã đó để xác nhận tài khoản của bạn',
//         style: TextStyle(
...
//                 if (value.isKeyPressed(LogicalKeyboardKey.backspace) && index > 0) {     
...
//                   if (value.isNotEmpty && index < 5 && int.tryParse(value) != null) {
//                     _focusNodes[index + 1].requestFocus();
...
//                 },
//                 style: const TextStyle(color: kTextColorDark, fontSize: 20),
//               ),
//             ),
//           ),
//         );
...
//         onPressed: () {
//           Routes.pushRightLeft(context, ScreenUpdatedpasswork());
//         },
