...
final tableFilterProvider = StateProvider<String>((ref) => 'Tất cả');
...
final List<Map<String, dynamic>> _initialTables = [
  {'name': 'A-1', 'capacity': 4, 'status': 'Trống', 'area': 'Khu trong nhà', 'type': 'Thường'},
  {'name': 'A-2', 'capacity': 6, 'status': 'Trống', 'area': 'Khu trong nhà', 'type': 'Thường'},
  {'name': 'A-3', 'capacity': 8, 'status': 'Trống', 'area': 'Ngoài trời', 'type': 'Thường'},
  {'name': 'A-4', 'capacity': 4, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-5', 'capacity': 6, 'status': 'Trống', 'area': 'Ngoài trời', 'type': 'Thường'},
  {'name': 'A-6', 'capacity': 8, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-7', 'capacity': 2, 'status': 'Trống', 'area': 'Khu Tiên', 'type': 'VIP'},
  {'name': 'A-8', 'capacity': 2, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-9', 'capacity': 8, 'status': 'Trống', 'area': 'Ngoài trời', 'type': 'VIP'},
  {'name': 'A-10', 'capacity': 4, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-11', 'capacity': 6, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-12', 'capacity': 8, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-13', 'capacity': 4, 'status': 'Trống', 'area': 'Ngoài trời', 'type': 'Thường'},
  {'name': 'A-14', 'capacity': 6, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-15', 'capacity': 8, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
  {'name': 'A-16', 'capacity': 2, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'VIP'},
  {'name': 'A-17', 'capacity': 6, 'status': 'Trống', 'area': 'Ngoài trời', 'type': 'Thường'},
  {'name': 'A-18', 'capacity': 8, 'status': 'Trống', 'area': 'Trong nhà', 'type': 'Thường'},
];
