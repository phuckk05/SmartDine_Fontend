...
class TodayActivitiesNotifier extends RealtimeNotifier<TodayActivitiesData> {
  final OrderManagementAPI _orderApi;
  final TableManagementAPI _tableApi;
  final int _branchId;

  TodayActivitiesNotifier(this._orderApi, this._tableApi, this._branchId);

  @override
  Future<TodayActivitiesData> loadData() async {
    ...
    if (summaryData != null) {
      ...
      throw Exception('Không thể tải dữ liệu hoạt động hôm nay');
    }
  }

  @override
  Duration get pollingInterval => const Duration(seconds: 30); // Update every 30 seconds for real-time activities
}