...
import 'package:me_talk/features/signin/screen/screen_signin.dart';
    ...
    Future.delayed(const Duration(milliseconds: 300), () {
      ...
      Future.delayed(const Duration(seconds: 2), () {
        ...
        Future.delayed(const Duration(seconds: 1), () {
          ...
          ref.read(heightProvider.notifier).state = currentHeight == 150 ? MediaQuery.of(context).size.height : 150;
          ref.read(widthProvider.notifier).state =currentWidth == 150 ? MediaQuery.of(context).size.width : 150;
